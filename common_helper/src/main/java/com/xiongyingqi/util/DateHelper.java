...
public class DateHelper {
    ...
    public static Date getNowDate() {
        ...
        Date currentTime_2 = FORMATTER_LONG.parse(dateString, pos);
        return currentTime_2;
    }

    /**
     * php时间转java.util.Date必须为10位数字值 <br>
     * 2013-8-19 下午10:10:12
     *
     * @param timeStamp
     * @return
     */
    public static Date phpDateToJavaDate(int timeStamp) {
    ...
    public static Date getNowDateShort() {
        Date currentTime = new Date();
        String dateString = FORMATTER_SHORT.format(currentTime);
        ParsePosition pos = new ParsePosition(8);
        Date currentTime_2 = FORMATTER_SHORT.parse(dateString, pos);
        return currentTime_2;
    }
    ...
    public static Date strToDate(String strDate) {
        ParsePosition pos = new ParsePosition(0);
        Date strtodate = FORMATTER_SHORT.parse(strDate, pos);
        return strtodate;
    }
    ...
    public static String getEDate(String str) {
        ParsePosition pos = new ParsePosition(0);
        Date strtodate = FORMATTER_SHORT.parse(str, pos);
    ...
    public static String getWeek(String sdate, String num) {
        // 再转换为时间
        Date dd = DateHelper.strToDate(sdate);
