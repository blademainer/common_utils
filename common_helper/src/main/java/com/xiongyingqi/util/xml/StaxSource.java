 ...
 * input source obtained via {@link #getInputSource()}. Calling {@link #setXMLReader(org.xml.sax.XMLReader)}
 * or {@link #setInputSource(org.xml.sax.InputSource)} will result in {@code UnsupportedOperationException}s.
 *
...
class StaxSource extends SAXSource {
     ...
     * @see com.xiongyingqi.util.xml.StaxSource#StaxSource(javax.xml.stream.XMLEventReader)
     */
