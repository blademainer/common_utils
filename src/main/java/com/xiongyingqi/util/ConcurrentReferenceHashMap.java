...
/**
 * A {@link java.util.concurrent.ConcurrentHashMap} that uses {@link com.xiongyingqi.util.ConcurrentReferenceHashMap.ReferenceType#SOFT soft} or
 * {@linkplain com.xiongyingqi.util.ConcurrentReferenceHashMap.ReferenceType#WEAK weak} references for both {@code keys} and {@code values}.
 * <p/>
 ...
 * same design constraints as {@link java.util.concurrent.ConcurrentHashMap} with the exception that
 ...
 * {@linkplain java.lang.ref.SoftReference soft entry references}.
 *
...
public class ConcurrentReferenceHashMap<K, V> extends AbstractMap<K, V> implements ConcurrentMap<K, V> {
    ...
    /**
     * Factory method that returns the {@link com.xiongyingqi.util.ConcurrentReferenceHashMap.ReferenceManager}. This method will be
     * called once for each {@link com.xiongyingqi.util.ConcurrentReferenceHashMap.Segment}.
     *
     ...
     * {@link java.util.concurrent.ConcurrentHashMap}. Subclasses can override to provide alternative hashing.
     *
    ...
    /**
     * Returns a {@link com.xiongyingqi.util.ConcurrentReferenceHashMap.Reference} to the {@link com.xiongyingqi.util.ConcurrentReferenceHashMap.Entry} for the specified {@code key} or
    ...
    public static enum ReferenceType {
        ...
        /**
         * Use {@link java.lang.ref.SoftReference}s.
         */
        SOFT,

        /**
         * Use {@link java.lang.ref.WeakReference}s.
         */
        WEAK
    }
    ...
    /**
     * A reference to an {@link com.xiongyingqi.util.ConcurrentReferenceHashMap.Entry} contained in the map. Implementations are usually
     * wrappers around specific Java reference implementations (e.g., {@link java.lang.ref.SoftReference}).
     */
    protected static interface Reference<K, V> {
         ...
         * {@link com.xiongyingqi.util.ConcurrentReferenceHashMap.ReferenceManager#pollForPurge()}.
         */
        void release();
    }
    ...
    /**
     * A task that can be {@link com.xiongyingqi.util.ConcurrentReferenceHashMap.Segment#doTask run} against a {@link com.xiongyingqi.util.ConcurrentReferenceHashMap.Segment}.
     */
    private abstract class Task<T> {
         ...
         * @see #execute(com.xiongyingqi.util.ConcurrentReferenceHashMap.Reference, com.xiongyingqi.util.ConcurrentReferenceHashMap.Entry)
         */
        ...
        /**
         * Convenience method that can be used for tasks that do not need access to {@link com.xiongyingqi.util.ConcurrentReferenceHashMap.Entries}.
         *
         * @param reference the found reference or {@code null}
         * @param entry     the found entry or {@code null}
         * @return the result of the task
         * @see #execute(com.xiongyingqi.util.ConcurrentReferenceHashMap.Reference, com.xiongyingqi.util.ConcurrentReferenceHashMap.Entry, com.xiongyingqi.util.ConcurrentReferenceHashMap.Entries)
         */
    ...
    /**
     * Various options supported by a {@link com.xiongyingqi.util.ConcurrentReferenceHashMap.Task}.
     */
    ...
    /**
     * Allows a task access to {@link com.xiongyingqi.util.ConcurrentReferenceHashMap.Segment} entries.
     */
    ...
    /**
     * Strategy class used to manage {@link com.xiongyingqi.util.ConcurrentReferenceHashMap.Reference}s. This class can be overridden if
    ...
    protected class ReferenceManager {
        ...
        /**
         * Factory method used to create a new {@link com.xiongyingqi.util.ConcurrentReferenceHashMap.Reference}.
         *
         * @param entry the entry contained in the reference
         * @param hash  the hash
         * @param next  the next reference in the chain or {@code null}
         * @return a new {@link com.xiongyingqi.util.ConcurrentReferenceHashMap.Reference}
         */
    ...
    /**
     * Internal {@link com.xiongyingqi.util.ConcurrentReferenceHashMap.Reference} implementation for {@link java.lang.ref.SoftReference}s.
     */
    ...
    /**
     * Internal {@link com.xiongyingqi.util.ConcurrentReferenceHashMap.Reference} implementation for {@link java.lang.ref.WeakReference}s.
     */
