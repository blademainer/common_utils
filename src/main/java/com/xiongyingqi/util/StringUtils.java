...
public abstract class StringUtils {
    ...
    /**
     * Parse the given {@code timeZoneString} value into a {@link java.util.TimeZone}.
     *
     * @param timeZoneString the time zone String, following {@link java.util.TimeZone#getTimeZone(String)}
     *                       but throwing {@link IllegalArgumentException} in case of an invalid time zone specification
     * @return a corresponding {@link java.util.TimeZone} instance
