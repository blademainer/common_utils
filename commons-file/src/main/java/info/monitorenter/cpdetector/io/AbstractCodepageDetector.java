 ...
 * {@link #open(java.net.URL)}of the implemented interface ICodepageProcessor.
 * </p>
 * <p>
...
public abstract class AbstractCodepageDetector implements ICodepageDetector {
    ...
    /**
     * A default delegation to {@link #detectCodepage(java.net.URL)}that opens the document specified by the given URL with the
     * detected codepage.
     * <p>
     * 
     * @see ICodepageDetector#open(java.net.URL)
     */
